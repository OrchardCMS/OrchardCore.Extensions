...
features:
  - id: Etch.OrchardCore.Fields
    name: Etch Fields
    description: "Collection of useful content fields for Orchard Core. Its catalog feature ID is `Etch.OrchardCore.Fields`. No additional feature dependencies are listed for it in this catalog entry. This description is based on the package manifest metadata already recorded in this catalog; in Orchard Core, feature entries are shown in the feature management UI with their description, category, and dependencies."
---
### Code
