...
description:
  Redis configuration support. It includes Redis, Redis Cache and related features in the Distributed and
  Security area, making the package easier to find when browsing related Orchard Core capabilities,
