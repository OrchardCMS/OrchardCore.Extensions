...
description:
  Microsoft.AspnetCore.OpenApi module for Orchard Core. It includes OpenApi, OpenApi Swagger UI and related
  features in the Api area, making the package easier to find when browsing related Orchard Core capabilities,
