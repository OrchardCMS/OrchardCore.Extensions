---
title: "AI Documents indexing using Elasticsearch"
slug: CrestApps.OrchardCore.AI.Documents.Elasticsearch
description:
...
features:
  - id: CrestApps.OrchardCore.AI.Documents.Elasticsearch
    ...
    description: "Provides services to index AI Documents in Elasticsearch indexes. Its manifest-backed feature ID is `CrestApps.OrchardCore.AI.Documents.Elasticsearch`, and it is categorized as Artificial Intelligence - Knowledgebase. It depends on `CrestApps.OrchardCore.AI.Documents`, and `OrchardCore.Elasticsearch`, so Orchard Core enables those dependencies when this feature is enabled. This description is based on the CrestApps manifest and documentation; in Orchard Core, feature entries are shown in the feature management UI with their description, category, and dependencies."
...
### AI Documents indexing using Elasticsearch
